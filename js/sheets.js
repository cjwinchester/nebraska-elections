...
// column names are inserted between .gsx$ and $t
        function displayContent(json) {            
            ...
            '<table id = "election" style="width:100%;"><thead><tr><th class="r" style="text-align:left">Race</th><th class="r">Candidate</th><th class="r">Votes</th><th class="rw">Percentage</th><th class="r">Precincts reporting</th><th class="r">Pie!</th></tr></thead><tbody>';
            var table_content='';
